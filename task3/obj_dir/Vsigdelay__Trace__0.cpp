...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+4,(vlSelf->write_en));
    bufp->chgBit(oldp+5,(vlSelf->read_en));
    bufp->chgBit(oldp+6,(vlSelf->mic_input));
    bufp->chgCData(oldp+7,(vlSelf->dout),8);
    bufp->chgSData(oldp+8,(vlSelf->sigdelay__DOT__write_addr),9);
    bufp->chgSData(oldp+9,(vlSelf->sigdelay__DOT__read_addr),9);
    bufp->chgCData(oldp+10,(vlSelf->mic_input),8);
}
